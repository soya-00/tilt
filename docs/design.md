...
Why Tilt behaves the way it does, how it looks, and the decisions recorded so
they are not reopened. [Back to the README](../README.md).

---

## The five loops, in full
...
## Decisions, recorded so they are not reopened

Written while the phases were being built. The phase table itself is in the
...
It still arrives over loopback through the settings API, and the README used
